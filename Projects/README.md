# All Projects by Murad Khan

A collection of 21 automation, AI, and data projects showcasing workflow automation, web scraping, CRM integrations, and intelligent AI solutions.
...
|---|---------|------------|------|
| 1 | [Automated Competitor Research](./automated-competitor-research) | n8n, Apify, Jina AI, Trustpilot API | [Part 1](https://drive.google.com/file/d/1rypto70MfXMtjPVIHb2kxlmlXevU5rMg/view?usp=sharing) / [Part 2](https://drive.google.com/file/d/1GdvIXBDoVvfNsehh7yh7mbmlagXkW-4F/view?usp=sharing) |
| 2 | [AI Invoice Classifier](./ai-invoice-classifier) | n8n, OCR, AI/ML, Google Drive | [Watch Demo](https://drive.google.com/file/d/1uSCVy5_o1Dv_xqRrdEPrFDgfg95kL1Dq/view?usp=sharing) |
| 3 | [AI Social Media Image Generator](./ai-social-media-image-generator) | n8n, DALL-E, Google Drive, CMS API | [Watch Demo](https://drive.google.com/file/d/1gzVXkxSHeKdMn4-WWaGaWk66JpJwdOIo/view?usp=sharing) |

## Agentic AI & CRM Automation

| # | Project | Tech Stack | Demo |
|---|---------|------------|------|
| 4 | [Candidate Marketing Agent (CMA)](./candidate-marketing-agent) | n8n, Claude AI, Apollo.io, Bullhorn CRM, RestCountries API | [Watch Demo](https://drive.google.com/file/d/1snHrlx8vKu4zWpGvp6s6jE7nYwNr6UX4/view?usp=sharing) |
| 5 | [Financial Planning Companies Monitor (FCMA)](./financial-candidate-marketing-agent) | n8n, Apollo.io, Bullhorn CRM, n8n Data Tables | [Watch Demo](https://drive.google.com/file/d/17IvDXmp6hdGKE6Qxu4WHr3ZKIsJuOTP_/view?usp=sharing) |

## Workflow Automation & CRM

| # | Project | Tech Stack | Demo |
|---|---------|------------|------|
| 6 | [HubSpot Deal to Linear Sync](./hubspot-deal-linear-sync) | n8n, HubSpot API, Linear API | [Watch Demo](https://drive.google.com/file/d/1K74EwAtc86C-zitvvlDDEuE2ivM_EukA/view?usp=sharing) |
| 7 | [GHL New Buyer Contact Sync](./ghl-buyer-contact-sync) | n8n, GoHighLevel, REST API | [Watch Demo](https://drive.google.com/file/d/1O8Qb9oa0EraMd360qMxE-RCEkUMTBEqu/view?usp=sharing) |
...
| # | Project | Tech Stack | Demo |
|---|---------|------------|------|
| 20 | [Automated Newsletter System](./automated-newsletter-system) | n8n, GPT, Mailchimp/SendGrid | [Watch Demo](https://drive.google.com/file/d/1XhFZS3fN8n3t-SI-IjAtg6Ad_zJsBzdz/view?usp=sharing) |

## Web Scraping

| # | Project | Tech Stack | Demo |
|---|---------|------------|------|
| 21 | [Zillow Property & Agent Scraper](./zillow-property-scraper) | n8n, Apify, Google Sheets, Proxy | [Watch Demo](https://drive.google.com/file/d/101ueiDtjBPGaKnE8tua1n_cv36ArbeW5/view?usp=sharing) |

---

Visit my portfolio: [murad-khan-portfolio.vercel.app](https://murad-khan-portfolio.vercel.app/)
